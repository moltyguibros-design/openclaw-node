...
| 2 | 2.7 | v2.7 | [A] | Pipeline mode implemented — the D16 fixed-pass protocol (`PIPELINE_MODE_SPEC.md`, D18) as a fourth `architecture`, with the three circling hang paths (all-nodes barrier, unanimity vote, tier gate) absent from it |
