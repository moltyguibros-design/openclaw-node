...
**Date:** 2026-05-28 · adapted for the **repair plan** 2026-06-02 (protocol unchanged from the redesign plan; plan-doc references repointed). This is the connective tissue: how an intent becomes a deployed, observed change. It marries the new discipline layer (MASTER_PLAN + runtime-evidence) with the old 9-phase execution rigor (FRAMEWORK.md) so neither is bypassed.
