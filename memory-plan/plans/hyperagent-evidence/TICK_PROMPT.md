...
3. **Phase 4 · implement** — only the §6 deltas. **Tripwire (PROTOCOL §5.3): sprawl or ≥2 mid-impl findings → the step wasn't atomic → BLOCK proposing a split.** VERSION → `vX.Y-mid`.
